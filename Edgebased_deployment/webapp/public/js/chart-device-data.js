...
$(document).ready(() => {
  // if deployed to a site supporting SSL, use wss:// (websockets)
  ...
  class TrackedDevices {
    ...
    // Find a device based on its univoque Id
    findDevice(deviceId) {
  ...
  const chartOptionsX = {
    scales: {
      yAxes: [{
        ...
        type: 'linear',
        scaleLabel: {
          labelString: 'Standing still or Moving',
          display: true,
        },
        position: 'left',
        ticks:{
